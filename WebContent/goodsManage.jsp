...
<body style="margin: 10px;">
  <%@ include file="head.jsp"%>
	<table style="height:550px"  id="dg" title="商品管理" class="easyui-datagrid" fitColumns="true" 
	...
	closed="true" buttons="#dlg-buttons">
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					<td>供应商：</td>
					<td><input value="请选择" class="easyui-combobox" id="proId" name="goods.proId" size="10" data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'proName',url:'${pageContext.request.contextPath}/stockManageSystem/provider!providerComboList'"/></td>
